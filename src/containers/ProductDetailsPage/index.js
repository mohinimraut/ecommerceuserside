...
const ProductDetailsPage = (props) => {
  ...
  const dispatch = useDispatch();
  const product = useSelector(state => state.product);
//below useEffect it componentDidMount or componentDidUpdate
  useEffect(() => {
    const { productId } = props.match.params;
...
//below we are checking productDetails is an object.Initial state of productDetails.
// After calling useEffect we get productDetails object then return Layout
  ...
  return (
    <Layout>
      ...
      {/* cost and name is dynamic rest are static */}
            ...
            <div className="flexRow">
              <MaterialButton
               ...
               onClick={()=>{
                ...
                //below we are passing the object that nothing but a product
                dispatch(addToCart({_id,name,price,img}));
                //You reload youlost everything that we have to store details in temporary local storage from the browser side local storage
